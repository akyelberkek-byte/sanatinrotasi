...
export async function generateMetadata(): Promise<Metadata> {
  const page = await client.fetch(PAGE_BY_SLUG_QUERY, { slug: "kvkk" });
  return {
    title: page?.seo?.metaTitle || page?.title || "KVKK Aydınlatma Metni",
    description:
      page?.seo?.metaDescription ||
      page?.subtitle ||
      "Sanatın Rotası Kişisel Verilerin Korunması Kanunu (KVKK) Aydınlatma Metni",
  };
}
